  ...
  return (
    ...
    >
      <Image
        ...
        alt=''
        className={cn(
          'lg:w-[40%] w-full min-h-full object-cover inset-0 max-lg:absolute -z-10',
          { 'lg:w-full absolute': props.contactPage }
        )}
        width={500}
        height={1300}
      />
      <MessageForm
        ...
        className={cn(
          'max-lg:mx-5 max-lg:my-20 rounded-lg  grow bg-background'
        )}
      />
    </section>
  );
